...
VALUES ('Alice', 'McLoud', 'mcloud@gmail.com', '123456', '3104 46 ave', 'Calgary', 'Alberta', 'T3H5X5', '4034445566', 'https://maps.googleapis.com/maps/api/staticmap?fillcolor:black&center=Calgary,+AB+T3H+5X5&zoom=16&size=400x400&key=AIzaSyBQ5YU8kYJwyuSdmJNBCdFr1VJU_SEP8KM');
INSERT INTO users (first_name, last_name, email, password, address, city, province, postal_code, phone_number, map)
VALUES ('John', 'Doe', 'doe@gmail.com', '123456', '3104 46 ave', 'Calgary', 'Alberta', 'T3E6XS6', '4034445566', 'https://maps.googleapis.com/maps/api/staticmap?fillcolor:black&center=Calgary,+AB+T3H+5X5&zoom=16&size=400x400&key=AIzaSyBQ5YU8kYJwyuSdmJNBCdFr1VJU_SEP8KM');
INSERT INTO users (first_name, last_name, email, password, address, city, province, postal_code, phone_number, map)
VALUES ('Marry', 'Doe', 'marryd@gmail.com', '123456', '3104 46 ave', 'Calgary', 'Alberta', 'T3H2H3', '4034445566', 'https://maps.googleapis.com/maps/api/staticmap?fillcolor:black&center=Calgary,+AB+T3H+5X5&zoom=16&size=400x400&key=AIzaSyBQ5YU8kYJwyuSdmJNBCdFr1VJU_SEP8KM');
