    ...
    <div className={classes.filter}>
      <form>
        <div className={classes.radios}>
          ...
          />
          <label htmlFor='radio-1'>Tools</label>
          <input
            type='radio'
            value='sports'
            id='radio-2'
          ...
          />
          <label htmlFor='radio-2'>Sports Equipment</label>
          <input
            type='radio'
            value='electronics'
            id='radio-3'
          ...
          />
          <label htmlFor='radio-3'>Electronics</label>
          <input
            type='radio'
            value='all'
            id='radio-4'
          ...
          />
          <label htmlFor='radio-4'>All</label>
        </div>
      </form>
      <form className={classes.postal}>
        <div>
          <label className={classes.postalLabel} htmlFor='postal_code'>
            Postal Code
          </label>
          <input
